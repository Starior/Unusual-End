...
public class UnusualEndPotions {
	public static final DeferredRegister<Potion> REGISTRY = DeferredRegister.create(BuiltInRegistries.POTION, UnusualEnd.MODID);
	public static final DeferredHolder<Potion, Potion> END_INFECTION = REGISTRY.register("end_infection", () -> new Potion(new MobEffectInstance(UnusualEndMiscRegister.ENDER_INFECTION, 3600, 0, false, true)));
	...
	public static final DeferredHolder<Potion, Potion> BUILDING_POTION = REGISTRY.register("building_potion", () -> new Potion(new MobEffectInstance(UnusualEndMiscRegister.DISRUPTION, 9600, 0, false, true)));
	public static final DeferredHolder<Potion, Potion> RESISTANCE = REGISTRY.register("resistance",
			() -> new Potion(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 2400, 0, false, true), new MobEffectInstance(UnusualEndMiscRegister.HEAVINESS, 1200, 0, false, true)));
	...
	public static final DeferredHolder<Potion, Potion> HEAVINESS_POTION = REGISTRY.register("heaviness_potion", () -> new Potion(new MobEffectInstance(UnusualEndMiscRegister.HEAVINESS, 3600, 1, false, true)));
	public static final DeferredHolder<Potion, Potion> SERENITY_POTION = REGISTRY.register("serenity_potion", () -> new Potion(new MobEffectInstance(UnusualEndMiscRegister.SERENITY, 3600, 0, false, true)));
	public static final DeferredHolder<Potion, Potion> SWIFT_STRIKES_POTION = REGISTRY.register("swift_strikes_potion", () -> new Potion(new MobEffectInstance(UnusualEndMiscRegister.SWIFT_STRIKES, 3600, 0, false, true)));
